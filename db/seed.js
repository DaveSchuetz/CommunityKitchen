      ...
      Recipe.find({}).remove(() => {
        User.create({
            ...
            Promise.all([
                Recipe.create({
                    name: "Pizza Dough",
                    ingredient: ["3 1/2 to 4 cups bread flour", "1 teaspoon sugar", "1 envelope instant dry yeast", "2 teaspoons kosher salt", "1 1/2 cups warm water", "2 tablespoons olive oil"],
                ...
                Recipe.create({
                    ...
                    ingredient: ["1 large egg", "2 pounds ground turkey","2/3 cup Panko", "3 Tablespoons olive oil", "1/4 cup grated parmesan cheese", "3 cloves garlic", "2 teaspoons dried oregano", "2 teaspoons dried basil", "3/4 teaspoon salt", "1/2 teaspoon pepper", "1 large onion", "two 28-ounce cans crushed tomatoes"],
